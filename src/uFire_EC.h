...
#define EC_CALIBRATE_LOW \
  10 /*!< Command to calibrate the low point of the probe */
#define EC_CALIBRATE_HIGH \
  8                /*!< Command to calibrate the high point of the probe */
...
#define EC_TEMP_COMPENSATION_REGISTER \
  45                              /*!< temperature compensation register */
...
#define EC_TEMP_COMPENSATION_CONFIG_BIT \
  1 /*!< temperature compensation config bit */
...
class uFire_EC /*! uFire_EC Class */
{
 public:
  ...
  static const float tempCoefEC; /*!< Temperature compensation coefficient for
                                    EC measurement */
  static const float tempCoefSalinity; /*!< Temperature compensation coefficient
  ...
  void setDualPointCalibration(float refLow, float refHigh, float readLow,
                               float readHigh);
  void reset();
  ...
  bool connected();
  void writeEEPROM(uint8_t address, float value);
