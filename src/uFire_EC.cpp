...
void uFire_EC::setDualPointCalibration(float refLow, float refHigh,
                                       float readLow, float readHigh) {
...
uint8_t uFire_EC::getVersion() { return _read_byte(EC_VERSION_REGISTER); }

uint8_t uFire_EC::getFirmware() { return _read_byte(EC_FW_VERSION_REGISTER); }
...
void uFire_EC::setBlocking(bool b) { _blocking = b; }

bool uFire_EC::getBlocking() { return _blocking; }
